...
//    }
    ...
    public static interface OneEntryHandler {
        public boolean onInit(Void/*Context*/ context);
...
//    };
    ...
    public VCardComposer(Void/*Context*/ context) {
        this(context, VCardConfig.VCARD_TYPE_DEFAULT, true, false, true);
    }

    public VCardComposer(Void/*Context*/ context, String vcardTypeStr,
            boolean careHandlerErrors) {
        this(context, VCardConfig.getVCardTypeFromString(vcardTypeStr),
                careHandlerErrors, false, true);
    }

    public VCardComposer(Void/*Context*/ context, int vcardType, boolean careHandlerErrors) {
